...
export _TPL_ROOT_DIR=~/src/proxyApp/buildInstall/installTPLwithKokkos4.2.01
...
kokkos_install_dir=~/src/proxyApp/buildInstall/installTPLwithKokkos4.2.01/kokkos
