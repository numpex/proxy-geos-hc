...
int main( int argc, char *argv[] )
{
    ...
    double coef0=-2.*invDx2*(h_coefx[1]+h_coefx[2]+h_coefx[3]+h_coefx[4]);
    coef0+=-2.*invDy2*(h_coefy[1]+h_coefy[2]+h_coefy[3]+h_coefy[4]);
    coef0+=-2.*invDz2*(h_coefz[1]+h_coefz[2]+h_coefz[3]+h_coefz[4]);
