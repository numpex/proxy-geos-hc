	       ...
	       for (int j=0;j<numberOfPointsPerElement;j++)
	       {
	         R[j]=0;
                ...
                for( int j1=0; j1<order+1; j1++ )
                {
                  ...
                  {
                    R[j]+=weights2D[m+i2*(order+1)]*(B[m+i2*(order+1)][0]*
                ...
                for( int j1=0; j1<order+1; j1++ )
                {
                  ...
                  {
                     int j=j1+j2*(order+1);
                     R[j]+=weights2D[i1+j2*(order+1)]*(B[i1+j2*(order+1)][1]*
                ...
                for( int j1=0; j1<order+1; j1++ )
                {
                  ...
                  {
                     int j=j1+j2*(order+1);
                     R[j]+=weights2D[i2+j1*(order+1)]*(B[i2+j1*(order+1)][2]*
                ...
                for( int j2=0; j2<order+1; j2++ )
                {
                   ...
                   {
                      R[j]+=weights2D[i1+n*(order+1)]*(B[i1+n*(order+1)][3]*
