...
#include <iostream>
  ...
  typedef Kokkos::View<float*,   MemSpace> vectorReal;
  typedef Kokkos::View<double*,  MemSpace> vectorDouble;
  ...
  typedef Kokkos::View<int***,    MemSpace> array3DInt;
  typedef Kokkos::View<float***,  MemSpace> array3DReal;
