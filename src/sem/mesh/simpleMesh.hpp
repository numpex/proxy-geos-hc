...
public:
  ...
  void localToGlobalNodes( const int & elementNumber, const int & nPointsPerElement, arrayInt & nodesList, vectorInt const & localToGlobal) const;
  #elif defined SEM_USE_KOKKOS
  void localToGlobalNodes( const int & elementNumber, const int & nPointsPerElement, arrayInt & nodesList, vectorInt const & localToGlobal) const;
  #else
  ...
  void getXi( const int & numberOfPointsPerElement, arrayReal & globalNodesCoords,
                     vectorInt & localToGlobal , arrayDouble const & Xi) const;
  #elif defined SEM_USE_KOKKOS
  void getXi( const int & numberOfPointsPerElement, arrayReal & globalNodesCoords,
                     vectorInt & localToGlobal , arrayDouble const & Xi) const;
  #else
  ...
  #ifdef SEM_USE_RAJA
  void getListOfInteriorNodes( const int & numberOfInteriorNodes, vectorInt const & listOfInteriorNodes ) const;
  #elif defined SEM_USE_KOKKOS
  void getListOfInteriorNodes( const int & numberOfInteriorNodes, vectorInt const & listOfInteriorNodes ) const;
  #else
  ...
  #ifdef SEM_USE_RAJA
  void getListOfBoundaryNodes( const int & numberOfBoundaryNodes, vectorInt const & listOfBoundaryNodes ) const;
  #elif defined SEM_USE_KOKKOS
  void getListOfBoundaryNodes( const int & numberOfBoundaryNodes, vectorInt const & listOfBoundaryNodes ) const;
  #else
