...
export SEM_TPL_ROOT_DIR=~/src/geosx/codes/proxyApp/buildInstall/installTPLCudaSupport
...
kokkos_install_dir=~/src/geosx/codes/proxyApp/buildInstall/installTPLCudaSupport/kokkos
